...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveBtn").click(function(){
			$.ajax({
				url:"${root}/textController/textUpdateDo.json",
				type:'POST',
				data:{	"id":$("#id").val(),
						"jjdm":$("#jjdm").val(),
						"kmmc":$("#kmmc").val(),
...
<input type="hidden" id="id" value="${po.id }" />
<table width="100%" align="center" border="1">
	<tr>
		<td>基金代码</td>
		<td><input id="jjdm" value="${po.jjdm }"/></td>
	</tr>
	<tr>
		<td>科目名称</td>
		<td><input id="kmmc" value="${po.kmmc }"/></td>
	</tr>
	<tr>
		<td>余额</td>
		<td><input id="yue" value="${po.yue }"/></td>
	</tr>
	<tr>
		<td colspan="2">
